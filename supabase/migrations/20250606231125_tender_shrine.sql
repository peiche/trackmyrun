/*
  # Complete RunTracker Database Schema

  1. New Tables
    - `profiles` - User profile information linked to Supabase auth
    - `runs` - Individual running activity records with metrics
    - `goals` - User-defined running goals with target metrics
  ...
  4. Analytics
    - Views for user statistics and progress tracking
